...
```text
2026-06-28: npm --cache /tmp/gameproject-npm-cache --prefix client run e2e:darkorbit-feel passed. It boots a real Postgres content DB, seeds the Kalaazu default snapshot, registers a real account, proves combat.start_attack payload minimization, observes three server-driven shot events while moving, portals from 1-1 through 1-2 to 1-3, scans browser/WebSocket/log state for hidden/fake data tokens, and writes output/screenshots/ui-implementation/darkorbit-feel/darkorbit-feel-desktop-1782651173871d0c2c27a461f28.png. This canary does not yet prove 1-3 live NPC density or NPC return fire; that remains a tracked DarkOrbit-feel gap.
