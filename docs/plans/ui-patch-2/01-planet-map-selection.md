...
7. Make map marker coordinates stable:
...
- Clicking discovered planet list opens/requests safe detail.
- Clicking planet marker selects planet detail and does not move the ship.
- Empty world click still moves.
- The selected planet keeps the same world coordinates while the ship moves.
- Hidden planet/future spawn/procedural seed data is not present in DOM, smoke
