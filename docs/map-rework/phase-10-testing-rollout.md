...
- No full per-map scanner/claim/drop seed matrix. A focused server-only claim
  success proof now covers seeded destination map `map_1_2` / public `1-2`,
  but scanner/drop matrix coverage and browser claim flow remain open.
