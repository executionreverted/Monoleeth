...
- Focused scanner rarity/hidden-scan-data regression exists in
  server/discovery tests, but browser hidden-scan-data leak proof and the
  per-map scanner/claim/drop matrix remain missing.
