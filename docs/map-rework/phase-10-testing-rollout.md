...
- PvP-enabled map seed now exists as public `1-3` / Border Skirmish, reachable
  ...
  reconciliation, and respawn protection. Real safe-zone PvP UI-click proof
  remains missing.
...
- Browser PvP death/cargo/checkpoint command-socket proof exists in
  `client/tests/e2e/phase10-pvp-death-flow.mjs`; remaining PvP browser gaps are
  real safe-zone UI-click rejection proof and broader deployed artifact/log
  canaries.
...
The Phase10 PvP proof uses two isolated real browser sessions and command
WebSockets. It does not capture screenshots and does not prove safe-zone PvP UI
click behavior.
