...
- Second/PvP-map enemy seeds exist, starter/destination browser fight/loot proof
  ...
  the server worker only. Browser respawn proof, aggro/leash browser proof, and
  broader per-map matrix coverage remain missing.
