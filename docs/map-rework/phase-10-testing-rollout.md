...
- PvP-enabled map seed now exists as public `1-3` / Border Skirmish, reachable
  ...
  out of queued client events, and blocks target actions before repair. Real
  browser PvP death/cargo/checkpoint proof and real browser safe-zone PvP click
