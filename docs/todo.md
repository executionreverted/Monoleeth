...
- [ ] Finish the DB/CMS content pipeline after the static gameplay content
  ...
  Kalaazu-resource loot tables, and a Kalaazu-owned starter config, with
  ...
  special item support, recipes, production buildings, quests, scanner config,
  route policy, production rules, and combat rules. Kalaazu speed-generator
  items now map into module speed stats. Next
