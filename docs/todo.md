...
- [ ] Finish the DB/CMS content pipeline after the static gameplay content
  ...
  item contract rows plus craft recipes, with
  ...
  production buildings, quests, production rules, and combat rules.
...
- [ ] Replace remaining explicit Kalaazu default-seed legacy bridge rows.
  ...
  production, quests, production rules, and combat rules still need domain-owned
  Kalaazu/default replacements.
  ...
  material/special item aliases plus starter craft recipes are now produced by
  the Kalaazu default seed builder.
  Source:
