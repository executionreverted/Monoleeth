...
- [ ] Finish the DB/CMS content pipeline after the static gameplay content
  ...
  ship definitions, supported laser/shield modules, fully Kalaazu-derived
  buyable shop rows, and Kalaazu-resource loot tables, with
...
- [ ] Replace remaining explicit Kalaazu default-seed legacy bridge rows.
  ...
  Kalaazu/default replacements. Shop products and loot tables are now produced
  by the Kalaazu default seed builder. Source:
