...
- [ ] Finish the DB/CMS content pipeline after the static gameplay content
  ...
  recipes, production buildings, quests, production rules, and combat rules.
...
- [ ] Replace remaining explicit Kalaazu default-seed legacy bridge rows.
  ...
  crafting, production, quests, production rules, and combat rules still need
  domain-owned Kalaazu/default replacements.
  ...
  material/special item aliases are now produced by the Kalaazu default seed
  builder.
  Source:
