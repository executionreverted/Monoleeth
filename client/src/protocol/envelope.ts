...
export const CLIENT_EVENTS = {
  ...
  combatAttackStarted: 'combat.attack_started',
  combatAttackStopped: 'combat.attack_stopped',
  combatShotStarted: 'combat.shot_started',
  combatShotResolved: 'combat.shot_resolved',
  combatStateSnapshot: 'combat.state_snapshot',
