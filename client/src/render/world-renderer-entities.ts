...
export abstract class WorldRendererEntities extends WorldRendererEffects {
  ...
  protected drawPlayerShip(view: Graphics, self: boolean): void {
    if (self) {
  ...
  protected drawNpcSwarm(view: Graphics, entity: EntityPayload): void {
  ...
  protected drawLootCache(view: Graphics): void {
  ...
  protected drawPlanetSignal(view: Graphics, entity: EntityPayload): void {
