...
func (runtime *Runtime) commandHandlers() map[realtime.Operation]realtime.CommandHandler {
	handlers := map[realtime.Operation]realtime.CommandHandler{
		...
		realtime.OperationInventoryMove:             runtime.handleInventoryMove,
		...
		realtime.OperationDiscoveryClaimPlanet:      runtime.handleClaimPlanet,
		realtime.OperationIntelShare:                runtime.handleIntelShare,
		realtime.OperationIntelCoordinateCreate:     runtime.handleIntelCoordinateItemCreate,
		realtime.OperationIntelCoordinateUse:        runtime.handleIntelCoordinateItemUse,
		...
		realtime.OperationPlanetBuildingBuild:       runtime.handlePlanetBuildingBuild,
		realtime.OperationPlanetBuildingUpgrade:     runtime.handlePlanetBuildingUpgrade,
		realtime.OperationRouteCreate:               runtime.handleRouteCreate,
		...
		realtime.OperationContentCatalog:            runtime.handleContentCatalog,
		...
		realtime.OperationChatSend:                  runtime.handleChatSend,
		realtime.OperationPartyInvite:               runtime.handlePartyInvite,
		realtime.OperationPartyAccept:               runtime.handlePartyAccept,
		realtime.OperationPartyLeave:                runtime.handlePartyLeave,
		realtime.OperationPartyTargetSet:            runtime.handlePartyTargetSet,
		realtime.OperationClanCreate:                runtime.handleClanCreate,
		realtime.OperationClanJoin:                  runtime.handleClanJoin,
		realtime.OperationClanLeave:                 runtime.handleClanLeave,
		...
		realtime.OperationAdminContentUpdateDraft:   runtime.handleAdminContentUpdateDraft,
		realtime.OperationAdminContentValidateDraft: runtime.handleAdminContentValidateDraft,
		realtime.OperationAdminContentPublish:       runtime.handleAdminContentPublish,
