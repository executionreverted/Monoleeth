...
func (runtime *Runtime) bootstrapEvents(resolved auth.ResolvedSession, lastSeenSeq ...uint64) ([]realtime.EventEnvelope, error) {
	...
	events = append(events, runtime.eventLocked(resolved.SessionID, realtime.EventCombatStateSnapshot, runtime.combatEngagementPayloadLocked(resolved.PlayerID, runtime.clock.Now())))
...
func (runtime *Runtime) postCommandEventsBySession(sessionID auth.SessionID, op realtime.Operation, playerID foundation.PlayerID) (map[auth.SessionID][]realtime.EventEnvelope, error) {
	...
	case realtime.OperationCombatUseSkill,
		...
		realtime.OperationCombatSelectAmmo,
		...
		realtime.OperationIntelCoordinateCreate,
		realtime.OperationIntelCoordinateUse,
		realtime.OperationProductionSummary,
		realtime.OperationPlanetStorage,
		realtime.OperationPlanetBuildingBuild,
		realtime.OperationPlanetBuildingUpgrade,
