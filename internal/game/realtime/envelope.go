...
const (
	...
	OperationPlanetBuildingUpgrade     Operation = "planet.building_upgrade"
	...
	OperationContentCatalog            Operation = "content.catalog"
	...
	OperationAdminContentList          Operation = "admin.content.list"
...
const (
	...
	EventPartyContribution     ClientEventType = "party.contribution_updated"
	EventClanUpdated           ClientEventType = "clan.updated"
	EventClanLeft              ClientEventType = "clan.left"
	EventClanContribution      ClientEventType = "clan.contribution_updated"
...
var registeredOperations = map[Operation]OperationSpec{
	...
	OperationPlanetBuildingBuild: {
		Operation:        OperationPlanetBuildingBuild,
		RateLimitPosture: RateLimitPostureIntentBurst,
	},
	OperationPlanetBuildingUpgrade: {
		Operation:        OperationPlanetBuildingUpgrade,
		RateLimitPosture: RateLimitPostureIntentBurst,
	},
	...
	OperationRouteEnable: {
		Operation:        OperationRouteEnable,
		RateLimitPosture: RateLimitPostureIntentBurst,
	},
	...
	OperationContentCatalog: {
		Operation:        OperationContentCatalog,
		RateLimitPosture: RateLimitPostureIntentBurst,
	},
	...
	OperationAdminContentList: {
		Operation:        OperationAdminContentList,
		RateLimitPosture: RateLimitPostureIntentBurst,
	},
	OperationAdminContentGet: {
		Operation:        OperationAdminContentGet,
		RateLimitPosture: RateLimitPostureIntentBurst,
	},
	OperationAdminContentUpdateDraft: {
		Operation:        OperationAdminContentUpdateDraft,
		RateLimitPosture: RateLimitPostureIntentBurst,
	},
